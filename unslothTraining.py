# -*- coding: utf-8 -*-
"""Qwen2_5_(3B)_GRPO_Final.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1tiQrc6LVOxdRDWsM5WMuLrYhPkUVt617
...
training_args = GRPOConfig(
    ...
    save_steps = 250,
    max_grad_norm = 0.1,
    report_to = "wand", # Can use Weights & Biases #pip install wandb
    output_dir = "outputs",
    run_name = "qwen_baby"
)
...
text = tokenizer.apply_chat_template([
    {"role" : "system", "content" : SYSTEM_PROMPT},
    {"role" : "user", "content" : "Which one is bigger - an aeroplane with 10 kgs or two travel bags of 5 kgs?"},
], tokenize = False, add_generation_prompt = True)
